<!-- Generated from .agents/skills/dotnet-naming-conventions/references/naming-reference.md. Do not edit this file directly. Edit the canonical copy and run: python3 scripts/validate-agent-skills.py --sync -->
