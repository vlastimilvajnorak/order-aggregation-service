...
<!-- Generated from .agents/skills/dotnet-10-development/SKILL.md. Do not edit this file directly. Edit the canonical copy and run: python3 scripts/validate-agent-skills.py --sync -->
# .NET 10 development
